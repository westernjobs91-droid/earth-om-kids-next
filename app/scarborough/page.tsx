    ...
    <div className="max-w-6xl mx-auto px-6 py-16">
      ...
      <div className="text-center mb-20">
        ...
        <p className="max-w-2xl mx-auto text-xl text-[#1F2E2A]/70">
          Professional kids yoga and mindfulness programs for schools, childcare centres, and families across Scarborough, Toronto.
        </p>
      ...
      <section className="mb-20">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { icon: "fa-map-marker-alt", title: "Serving Scarborough Since 2018", desc: "We work with schools, daycares, and families throughout Scarborough and East Toronto." },
            { icon: "fa-school", title: "Local School Partnerships", desc: "Trusted by multiple Scarborough schools and childcare centres for regular and seasonal programs." },
            { icon: "fa-clock", title: "We Come to You", desc: "Convenient on-site programs at your school, daycare, or home in Scarborough." }
          ].map((item, index) => (
            <motion.div 
              key={index}
      ...
      <section className="mb-20">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { title: "School Yoga Programs", desc: "In-class sessions and wellness programs tailored for Scarborough schools and daycares.", link: "/schools" },
            { title: "After-School Classes", desc: "Weekly kids yoga classes for toddlers, preschoolers, and school-age children in Scarborough.", link: "/families" },
            { title: "Workshops & Birthday Parties", desc: "Fun and mindful birthday parties and family workshops across Scarborough.", link: "/contact" }
          ].map((item, index) => (
            <motion.div 
              key={index}
      ...
      <div className="text-center bg-[#F8F1E9] rounded-3xl p-12">
        ...
        <p className="text-[#1F2E2A]/70 mb-8 max-w-md mx-auto">
          Whether you're a school, daycare, or parent in Scarborough — we’re here to help.
        </p>
        <Link href="/contact" className="inline-flex items-center justify-center gap-x-3 px-10 py-4 bg-[#2D5A4A] hover:bg-[#1F2E2A] transition text-white font-semibold rounded-3xl text-lg">
