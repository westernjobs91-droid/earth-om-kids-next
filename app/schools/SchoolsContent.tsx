      ...
      <section className="mb-20">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white p-8 rounded-3xl border border-[#E8D5B7]">
            ...
            <div className="mt-6 text-sm font-semibold">— Director, Beach Hill Montessori, Toronto</div>
          </div>
          <div className="bg-white p-8 rounded-3xl border border-[#E8D5B7]">
            ...
            <div className="mt-6 text-sm font-semibold">— Head of School, Lycée Français Toronto</div>
          </div>
        </div>
      </section>
