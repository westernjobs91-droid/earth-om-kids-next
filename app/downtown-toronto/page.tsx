    ...
    <div className="max-w-6xl mx-auto px-6 py-16">
      ...
      <div className="text-center mb-20">
        ...
        <p className="max-w-2xl mx-auto text-xl text-[#1F2E2A]/70">
          Professional kids yoga and mindfulness programs for schools, childcare centres, and families in Downtown Toronto and the surrounding areas.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { 
              ...
              desc: "We understand the unique needs of downtown schools, daycares, and busy families living in the core." 
            },
            { 
              icon: "fa-clock", 
              title: "Flexible Scheduling", 
              desc: "We work around tight downtown schedules with convenient on-site programs at your location." 
            },
            { 
              icon: "fa-users", 
              title: "Strong Local Partnerships", 
              desc: "Trusted by several downtown Toronto schools, Montessori programs, and childcare centres." 
            }
          ].map((item, index) => (
            <motion.div 
              key={index}
      ...
      <section className="mb-20">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { 
              title: "School & Childcare Programs", 
              desc: "In-class yoga and mindfulness sessions designed for busy downtown schools and daycares.", 
              link: "/schools" 
            },
            { 
              title: "After-School Classes", 
              desc: "Weekly kids yoga classes for families living and working in Downtown Toronto.", 
              link: "/families" 
            },
            { 
              title: "Workshops & Birthday Parties", 
              desc: "Mindful birthday parties and family workshops in downtown locations and community spaces.", 
              link: "/contact" 
            }
          ].map((item, index) => (
            <motion.div 
      ...
      <section className="mb-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: "🧠", title: "Better Focus", desc: "Helps children stay calm and focused in a busy urban environment." },
            { icon: "😊", title: "Emotional Regulation", desc: "Gives kids tools to manage stress from city life and school." },
            { icon: "🤝", title: "Social Connection", desc: "Builds confidence and positive peer relationships." },
            { icon: "🌿", title: "Mindful Living", desc: "Introduces healthy habits early in a fast-paced city." }
          ].map((item, index) => (
            <motion.div 
              key={index}
              className="bg-white p-8 rounded-3xl border border-[#E8D5B7]"
      ...
      <div className="text-center bg-[#F8F1E9] rounded-3xl p-12">
        ...
        <p className="text-[#1F2E2A]/70 mb-8 max-w-md mx-auto">
          Whether you're a school, daycare, or family in Downtown Toronto — we’d love to work with you.
        </p>
        <Link 
          href="/contact" 
          className="inline-flex items-center justify-center gap-x-3 px-10 py-4 bg-[#2D5A4A] hover:bg-[#1F2E2A] transition text-white font-semibold rounded-3xl text-lg"
