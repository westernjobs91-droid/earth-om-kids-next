    ...
    <>
      ...
      <section id="why-us" className="max-w-7xl mx-auto px-6 pt-20 pb-16">
        <div className="text-center mb-14">
          <div className="inline-block px-4 py-1 bg-[#A7C4A0]/20 text-[#2D5A4A] text-xs font-semibold tracking-[1.5px] rounded-full mb-4">WHY TORONTO SCHOOLS &amp; FAMILIES CHOOSE US</div>
          <h2 className="text-5xl tracking-tighter font-semibold heading-serif">A calm, playful &amp; heart-centered approach</h2>
          <p className="mt-4 max-w-md mx-auto text-lg text-[#1F2E2A]/70">Professional. Nurturing. Designed specifically for young children in real classroom and home environments.</p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Card 1 */}
          <motion.div 
            className="yoga-card bg-white p-8 rounded-3xl soft-shadow border border-[#E8D5B7]/60 cursor-pointer"
            whileHover={{ 
              y: -12, 
              scale: 1.015,
          ...
          >
            ...
            <h3 className="font-semibold text-2xl tracking-tight mb-3">School-Ready Programs</h3>
            <p className="text-[#1F2E2A]/70 leading-relaxed">Thoughtfully designed for classrooms, daycares, and Montessori settings. Sessions fit seamlessly into your daily rhythm.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="font-semibold text-2xl tracking-tight mb-3">Age-Appropriate (18mo+)</h3>
            <p className="text-[#1F2E2A]/70 leading-relaxed">Carefully structured for toddlers through elementary. Play-based, imaginative, and always developmentally appropriate.</p>
          </motion.div>
          ...
          >
            <div className="benefit-icon w-14 h-14 bg-[#2D5A4A]/10 rounded-2xl flex items-center justify-center mb-6">
              <i className="fa-solid fa-brain text-3xl text-[#2D5A4A]"></i>
            </div>
            <h3 className="font-semibold text-2xl tracking-tight mb-3">Real Classroom Impact</h3>
            <p className="text-[#1F2E2A]/70 leading-relaxed">Helps children regulate emotions, improve focus, reduce stress, and create calmer, more joyful learning environments.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="font-semibold text-2xl tracking-tight mb-3">Experienced &amp; Trusted</h3>
            <p className="text-[#1F2E2A]/70 leading-relaxed">Led by Taran Kaur, Registered Early Childhood Educator with nearly 10 years of experience working with young children.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-10">
          ...
          {/* Testimonial 1 */}
          <motion.div 
            className="bg-white p-8 rounded-3xl border border-[#E8D5B7] cursor-pointer"
            whileHover={{ 
              y: -8, 
              scale: 1.01,
